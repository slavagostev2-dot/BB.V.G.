...
- существующий `.github/workflows/bot-state-backup.yml` обрабатывает создание только веток `backup/*`;
...
**Проверки:** YAML разобран; оба embedded Python blocks скомпилированы; mock-сценарии подтвердили ротацию 10 -> 3, отсутствие удаления при двух ветках, блокировку ветки с уникальными commits и блокировку непроверенного нового backup.
