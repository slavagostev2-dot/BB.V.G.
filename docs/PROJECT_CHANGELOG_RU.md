...
колёсам. Одновременно 26 уже проверенных публичных каналов из окружения
BetBoom/стримеров оставались вне основной проверки, хотя хотя бы косвенно могли
публиковать колёса.

**Что изменено:**

- 26 публичных косвенно релевантных каналов добавлены в
  `public_sources.txt`; основной inventory вырос с 78 до 104, ночной остался 3,
  общий — 107;
...
- новый тематический публичный кандидат автоматически подхватывается ночным
  ...
  режим;
- разведка теперь охватывает до 150 известных источников и проверяет до 100
  отфильтрованных кандидатов, поэтому расширенный inventory не обрезается на
  прежнем лимите 100;
...
отбор ночных кандидатов, inventory 104 и маршруты панели; self-test,
production acceptance, security audit и preflight на 107 источниках прошли.
Живые heartbeat фиксируются после публикации candidate SHA.
