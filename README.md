...
- Реферальные колёса сохраняются и участвуют в автоучастии. Первичные карточки,
  напоминания и уведомления времени прокрутки остаются бесшумными; если хотя бы
  один аккаунт владельца действительно принял участие, Control Center отправляет
  один общий итог с честным состоянием каждого аккаунта. В VK такие события не
  отправляются.
