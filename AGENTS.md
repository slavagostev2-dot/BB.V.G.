...
6. После создания новой ветки `backup/*` workflow `.github/workflows/bot-state-backup.yml` автоматически оставляет ровно три последних проверенных обычных backup-ветки.
...
- после создания нового `backup/*` остаются ровно три последние проверенные ветки;
