...
def test_current_start_with_is_early_is_not_archived():
    ...
    assert result.server_start_at == datetime(
        2026, 8, 26, 15, 57, 46, 459000, tzinfo=timezone.utc
    )
...
def test_future_early_action_waits_instead_of_becoming_inactive():
    ...
    assert result.available_at == datetime(2026, 8, 26, 16, 30, tzinfo=timezone.utc)
